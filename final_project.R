...
library(scatterplot3d) # Data visualization
install.packages("reshape2")
library(reshape2) # transform data formation
library(sqldf) # transform data formation
library(randomForest) # classification and modeling
...
# Comment: Only three Variabels (Social Support, Healthy Life Expectancy and Freedom) are significant predictors because the p-values < 0.05.
